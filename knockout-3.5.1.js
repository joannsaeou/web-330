        ...
        (function(n) { "function" === typeof define && define.amd ? define(["exports", "require"], n) : "object" === typeof exports && "object" === typeof module ? n(module.exports || exports) : n(A.ko = {}) })(function(S, T) {
            ...
            a.a = function() {
                ...
                return {
                    ...
                    wc: function(b) {
                        var c = [];
                        b && a.a.D(b, function(b) { 0 > a.a.A(c, b) && c.push(b) });
                        return c
                    },
                    Mb: function(a,
                        b, c) {
            ...
            a.a.g = new function() {
                ...
                return {
                    ...
                    Ub: function(a, b, c) { a = e(a, !0); return a[b] || (a[b] = c) },
                    clear: f,
            ...
            var D = {
                ...
                Bd: function(b) {
                    ...
                    var c = 0;
                    a.a.P(this.U, function(a, b) { "dirty" !== a && (c += b.length) });
                    return c
                },
                ...
                extend: function(b) {
                    var c = this;
                    b && a.a.P(b, function(b, e) { var f = a.Ta[b]; "function" == typeof f && (c = f(c, e) || c) });
                    return c
                }
            };
            a.L(D, "init", D.qb);
            ...
            var F = {
                ...
                ya: function() { this.notifySubscribers(this[I], "beforeChange") }
            };
            ...
            a.Ha.fn = {
                remove: function(b) {
                    for (var c = this.v(), d = [], e = "function" != typeof b || a.O(b) ? function(a) { return a === b } : b, f = 0; f < c.length; f++) {
                        var g = c[f];
                        if (e(g)) {
                            0 === d.length && this.ya();
            ...
            var C = {
                    ...
                    Va: function() {
                        var b = [];
                        a.a.P(this[r].I, function(a, d) { b[d.Ka] = d.da });
                        return b
                    },
                    ...
                    ha: function(b) {
                        var c = this[r],
                            ...
                            e = !1;
                        if (!c.rb && !c.ra) {
                            if (c.l && !a.a.Sb(c.l) || d && d()) { if (!c.jc) { this.s(); return } } else c.jc = !1;
                            c.rb = !0;
                            try { e = this.zd(b) } finally { c.rb = !1 }
                            return e
                        }
                    },
                    zd: function(b) {
                    ...
                    s: function() {
                        var b = this[r];
                        !b.J && b.I && a.a.P(b.I, function(a, b) { b.s && b.s() });
                ...
                function b(b) {
                    ...
                    if (1 < d.length) {
                        for (var x = 0, B; B = d[x]; ++x) {
                            ...
                            } else if (58 === u) { if (!h && !p && 1 === q.length) { p = q.pop(); continue } } else if (47 === u && 1 < B.length && (47 === B.charCodeAt(1) || 42 === B.charCodeAt(1))) continue;
            ...
            (function() {
                    ...
                    if (g) {
                        ...
                        a.a.D(f, function(c) {
                            ...
                            try {
                                ...
                                }), "function" == typeof e && a.$(function() { e(b, r(f), J, x.$data, x) }, null, { l: b })
                            } catch (k) {
                ...
                a.i = {
                    ...
                    Cb: function(b, d) {
                        ...
                        return d[x] == e ? d : d.extend(function(a) { a[x] = e })
                    }
                };
            ...
            (function(b) {
                function c(c, e) {
                    ...
                    k ? k.subscribe(e) : (k = f[c] = new a.T, k.subscribe(e), d(c, function(b, d) {
                        ...
                        delete f[c];
                        l || e ? k.notifySubscribers(b) : a.na.zb(function() { k.notifySubscribers(b) })
                    }), l = !0)
                }
            ...
            (function() {
                ...
                var c = new a.ga;
                9 > a.a.W && (a.j.register = function(a) { return function(b) { return a.apply(this, arguments) } }(a.j.register), w.createDocumentFragment = function(b) {
                    return function() {
                        var c = b(),
                            f = a.j.dd,
                            g;
                        ...
                        "string" == typeof g && a.a.B(b, g, function(b) {
                            ...
                            if (l) {
                                try {
                                    ...
                                    p.unshift(e);
                                    k = l.apply(e, p)
                                } finally {!0 !== k && (b.preventDefault ? b.preventDefault() : b.returnValue = !1) }!1 === d.get(g + "Bubble") && (b.cancelBubble = !0, b.stopPropagation && b.stopPropagation())
                            }
                        })
                    })
                }
                ...
                init: function(b, c, d) {
                    function e(e) {
                        ...
                        if ("activeElement" in f) {
                            var g;
                            try { g = f.activeElement } catch (l) { g = f.body }
                            e = g === b
                        }
                        f = c();
            ...
            a.kc = function() {
                ...
                return {
                    xd: function(b, c, d) { c.isTemplateRewritten(b, d) || c.rewriteTemplate(b, function(b) { return a.kc.Ld(b, c) }, d) },
                    Ld: function(a, f) { return a.replace(c, function(a, c, d, e, l) { return b(l, c, d, f) }).replace(d, function(a, c) { return b(c, "\x3c!-- ko --\x3e", "#comment", f) }) },
                    md: function(b, c) {
            ...
            (function() {
                ...
                a.dc = function(b, c, h, m, t) {
                    ...
                    if (m) {
                        ...
                        }, null, { Sa: function() { return !x || !a.a.Sb(x) }, l: x && "replaceNode" == t ? x.parentNode : x })
                    }
                ...
                function b(b, c, d, h, m) {
                    var k = [],
                        l = a.$(function() {
                            ...
                            k.length = 0;
                            a.a.Nb(k, l)
                        }, null, { l: b, Sa: function() { return !a.a.kd(k) } });
                    return { Y: k, $: l.ja() ? l : n }
                }
                var c = a.a.g.Z(),
                    d = a.a.g.Z();
